      ...
      <section className="h-svh w-full relative">
        ...
        <div className="absolute top-0 bottom-0 left-0 right-0 w-full h-full pt-[var(--mobileHeaderHeight)] lg:pt-[var(--desktopHeaderHeight) p-5 text-white">
          <div className="flex flex-col lg:flex-row gap-5 w-full h-full pt-5">
            <h1 className="flex justify-start items-start font-medium md:font-semibold text-h2 md:text-h1 lg:text-h2 xl:text-h1 w-fit">
              390 Acres
            </h1>
            ...
            <h1 className="font-medium md:font-semibold text-h2 md:text-h1 lg:text-h2 xl:text-h1 w-full lg:w-fit flex justify-end items-end">
              $25,000,000
            </h1>
          </div>
        </div>
